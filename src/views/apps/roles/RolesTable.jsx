...
import RoleDialog1 from '@/components/dialogs/role-dialog';
import RoleDialog from '../../../components/dialogs/role-dialog-edit';
...
const RolesTable = ({ tableData }) => {
  console.log('role and perm data', tableData);
        ...
        <div className='flex justify-between p-5 gap-4 flex-col items-start sm:flex-row sm:items-center'>
          ...
          <div className='flex items-center gap-x-4 is-full gap-4 flex-col sm:is-auto sm:flex-row'>
            <DebouncedInput
              ...
              className='is-full sm:is-auto'
            />
            <Button variant='contained' onClick={() => handleAddRole()} className='is-full sm:is-auto'>
              Add Role
            </Button>
          </div>
        </div>
        <div >
          <RoleDialog1 open={openNewDialog} setOpen={setOpenNewDialog} />
        </div>
        <div>
          <RoleDialog open={openEditDialog} setOpen={setOpenEditDialog} editId={editId} retrievedRoleData={retrievedRoleData} editPermissionData={editPermissionData} />
        </div>
